...
set CLASSPATH=%APP_HOME%\lib\project1.jar;%APP_HOME%\lib\diskmgr.jar;%APP_HOME%\lib\heap.jar;%APP_HOME%\lib\index.jar;%APP_HOME%\lib\parser.jar;%APP_HOME%\lib\query.jar;%APP_HOME%\lib\relop.jar

@rem Execute project1
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %PROJECT1_OPTS%  -classpath "%CLASSPATH%" global.Msql %CMD_LINE_ARGS%
